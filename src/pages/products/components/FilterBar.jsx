  ...
  return (
    <section className="filter">
      <div
        ...
        className={`fixed z-40 h-screen p-5 overflow-y-auto bg-PrimaryLighter w-72 dark:bg-darkSecondaryLight transition-transhtmlForm left-0 top-0 transhtmlForm-none`}
        tabIndex="-1"
      ...
      >
        <h5
          ...
          className="text-base font-semibold text-gray-700 uppercase dark:text-neutral-300"
        >
          Filters
        </h5>
        <button
          ...
          className="text-neutral-300 bg-transparent hover:bg-gray-200 hover:text-gray-700 rounded-lg text-sm p-1.5 absolute top-2.5 right-2.5 inline-flex items-center dark:hover:bg-darkSecondary dark:hover:text-white cursor-pointer"
        >
          <svg
            aria-hidden="true"
            className="w-5 h-5"
        ...
        <div className="py-4 overflow-y-auto">
          <ul className="text-Accent dark:text-neutral-100">
            <li className="mt-1 mb-5">
              ...
              <div className="flex items-center my-1">
                ...
                <label
                  ...
                  className="ml-2 text-sm font-medium text-gray-700 dark:text-neutral-300"
                >
                  Price - Low to High
                </label>
              </div>
            ...
            <li className="mt-1 mb-5 px-1">
              <button
                ...
                type="button"
                className="text-white bg-Tertiary border border-gray-300 focus:outline-none hover:bg-TertiaryDarker focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-10 py-2.5 mr-2 mb-2 dark:bg-darkTertiary dark:text-black dark:border-gray-600 dark:hover:bg-darkTertiaryDarker dark:hover:border-gray-600 dark:focus:ring-gray-700 cursor-pointer"
              >
                Clear Filter(s)
              </button>
            </li>
